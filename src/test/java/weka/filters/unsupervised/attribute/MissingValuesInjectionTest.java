...
/**
 * Tests MissingValuesInjection. Run from the command line with:
 * <pre>
 * java weka.filters.unsupervised.attribute.MissingValuesInjectionTest
 * </pre>
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class MissingValuesInjectionTest
   ...
   */
  public MissingValuesInjectionTest(String name) {
    super(name);
  ...
  public Filter getFilter() {
    return new MissingValuesInjection();
  }
  ...
  public static Test suite() {
    return new TestSuite(MissingValuesInjectionTest.class);
  }

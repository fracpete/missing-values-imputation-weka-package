...
/**
 * Tests the RandomPercentage algorithm.
 *
...
public class RandomPercentageTest
   ...
   */
  public RandomPercentageTest(String name) {
    super(name);
  }
  ...
  public Injection getInjection() {
    RandomPercentage 	result;

    result = new RandomPercentage();

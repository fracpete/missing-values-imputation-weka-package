...
/**
 * SimpleNearestNeighborTest.java
...
/**
 * Tests the SimpleNearestNeighbor algorithm.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class SimpleNearestNeighborTest
   ...
   */
  public SimpleNearestNeighborTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(SimpleNearestNeighborTest.class);
  }

...
/**
 * Tests the SupervisedPrediction algorithm.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class SupervisedPredictionTest
   ...
   */
  public SupervisedPredictionTest(String name) {
    super(name);
  }
  ...
  public Imputation getImputation() {
    return new SupervisedPrediction();
  }
  ...
  public static Test suite() {
    return new TestSuite(SupervisedPredictionTest.class);
  }

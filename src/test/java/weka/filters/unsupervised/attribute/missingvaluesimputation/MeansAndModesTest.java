...
/**
 * Tests the MeansAndModes algorithm.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 * @version $Revision$
 */
public class MeansAndModesTest
   ...
   */
  public MeansAndModesTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(MeansAndModesTest.class);
  }
